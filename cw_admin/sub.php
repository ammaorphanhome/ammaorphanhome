    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        <div class="page-title">
          ...
          <div><h1>Submissions Details</h1></div>
			
		<div>
            <ul class="breadcrumb">
              <li><i class="fa fa-home fa-lg"></i></li>
              <li class="active"><a href="sub.php">Submissions </a></li>
            </ul>
          </div>
	  ...
	  <?php  if(isset($action) && $action=='viewDetails') { 
	   $q = $_GET['guid'];
	   $sth = $db->query ('SELECT * FROM `sub` WHERE `guid`="'.$q.'"');
	   $row = $sth->fetch();
	   ?>
	   
		  <div class="col-md-12">
		  <a href="<?php echo URL; ?>sub.php" class="btn btn-info">Back</a>
            <div class="card">
              ...
              <div class="card-body">
                <form method="post" action="<?php echo $_SEVER['PHP_SELF'];?>" enctype="multipart/form-data">
				  ...
				  <div class="form-group col-md-6">
                    ...
                    <input readonly class="form-control" value="<?php echo $row[2];?> <?php echo $row[3];?> ">
                  </div>
                  <div class="form-group col-md-6">
                    ...
                    <?php
                        ...
                        $q = $row[4];
	                     ...
	                     $sth1 = $db->query ("SELECT * FROM `countries` WHERE `guid`='$row[4]'");
	                    $row1= $sth1->fetch();
					 
                    
					?>
					<input readonly class="form-control" value="<?php echo $row1['name'];?>">
                 ...
                 <div class="form-group col-md-6">
                    <label class="control-label">Author's  E-mail</label>
                    <input readonly class="form-control" value="<?php echo $row[5];?>">
                  </div>
                  <div class="form-group col-md-6">
                    <label class="control-label">Mobile Number</label>
                    <input readonly class="form-control" value="<?php echo $row[6];?>">
                  </div>
				  <div class="clearfix"></div>
				  
				   <div class="form-group col-md-6">
                    <label class="control-label">Title of Absract</label>
                    <input readonly class="form-control" value="<?php echo $row[7];?>">
                  </div>
                 ...
                 <div class="form-group col-md-6">
					...
					<img src="../adminupload/<?php echo $row[9];?>" class="img thumbnail" style="width:150px;height:150px" >
					<a href="../adminupload/<?php echo $row[9];?>" download class="btn btn-danger">
					Download 
					</a>
	  ...
	  $q = $_GET['guid'];
	  $vth = $db->query ("DELETE FROM `sub` WHERE `guid`='".$q."'" );
	  header('location:'.URL.'sub.php'); 
	  } else { ?>
          <div class="col-md-12">
		  <div><!--a href="sub.php?action=add" class="btn btn-success"><i class="fa fa-lg fa-plus"></i>Add New</a--><!-- <a href="sub.php?action=edit" class="btn btn-info btn-flat"><i class="fa fa-lg fa-edit"></i></a><a href="#" class="btn btn-warning btn-flat"><i class="fa fa-lg fa-trash"></i></a>--></div>
		  <?php
            $sth = $db->query ("SELECT * FROM `sub` ORDER BY `guid` DESC");
			$count = $sth->rowCount(); ?>
            <div class="card">
              <div class="card-body">
                <table id="sampleTable" class="table table-hover table-bordered">
				  ...
				  <?php 
                    ...
                    <tr>
					  ...
					  <td class="center"><div class="btn btn-xs btn-group-xs"><a href="sub.php?action=viewDetails&guid=<?php echo $row[0]; ?>"  class="btn btn-warning"><i class="fa fa-eye icon-only"></i></a>  </div></td>
					  
					  <td class="center"><div class="btn btn-xs btn-group-xs"><a href="<?php echo URL; ?>sub.php?action=deleteData&guid=<?php echo $row[0]; ?>" class="btn btn-danger" onClick="return delete1();"><i class="fa fa-trash icon-only"></i></a> </div></td>
                    </tr>
	  <?php $m++; } } ?>
                  </tbody>
                </table>
