  ...
  <body class="sidebar-mini fixed">
    <div class="wrapper">
      ...
      <div class="content-wrapper">
	   ...
	   $row = $sth->fetch();
           ?>
		    <a href="<?php echo URL; ?>events.php?id=<?php echo $aid; ?>" class="btn btn-info">Back</a>
        <div class="row">
		<div class="col-md-6">
            <div class="card">
			  ...
			  <form role="form" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">
			   <div class="form-group">
                    <label class="control-label">Video</label>
                    <input type="text" name="image" value="<?php echo $row[image];?>" class="form-control" >
					<br>
			     	 <iframe width="300" height="150" src="<?php echo $row[image];?>" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
					<!--label>Upload<strong> MORE THAN ONE IMAGE</strong>&nbsp;&nbsp;At A Time</label-->
                  </div>
				  <div class="card-footer">
	...
	<script type="text/javascript">
	  ...
	  <?php } } else { ?>
		  <div class="row">
          <div class="col-md-12">
		  <div><a href="events.php?action=add&id=<?php echo $_GET[id];?>" class="btn btn-success"><i class="fa fa-lg fa-plus"></i>Add New</a>
		  ...
		  <!-- <a href="register.php?action=edit" class="btn btn-info btn-flat"><i class="fa fa-lg fa-edit"></i></a><a href="#" class="btn btn-warning btn-flat"><i class="fa fa-lg fa-trash"></i></a>--></div>
            <div class="card">
			 ...
			 <?php } else { ?>
				 ...
				 while($row = $sth->fetch()) { ?>
                <td align="center">
               <a class="example-image-link" data-lightbox="example-set" href="../adminupload/<?php echo $row['image'];?>"> <div class="gallery_events_bg">
			   
			  <iframe width="100%" height="215" src="<?php echo $row[image];?>" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
			   
			   
				</div></a>
				<span style="text-align:center"> <a href="<?php echo URL; ?>events.php?action=edit&q=<?php echo $row[0]; ?>&events=<?php echo $id; ?>" class="btn btn-primary icon-btn">Edit </a> <a href="<?php echo URL; ?>events.php?action=deleteData&guid=<?php echo $row[0]; ?>&id=<?php echo $row[1]; ?>" class="btn btn-danger" onClick="return delete1();">Delete </a></span>
                    </td>
				 <?php if($m%3==0) { ?> </tr><tr>	<?php   } $m++; ?>
			 <?php } } ?>
				</tr>
                </table>
              </div>
