          ...
          <div class="col-md-6">
            <div class="card">
              <div class="card-title-w-btn">
                ...
                <p><a href="http://bootstrap-notify.remabledesigns.com/" target="_blank" class="btn btn-primary icon-btn"><i class="fa fa-file"></i>Docs</a></p>
              </div>
              <div class="card-body">
                <p>This plugin can be used to notify user about status of some action which he has performed.</p>
                <h4>Demo</h4><a id="demoNotify" href="#" class="btn btn-info">Sample Notification</a>
              </div>
            </div>
          </div>
          <div class="col-md-6">
            <div class="card">
              <div class="card-title-w-btn">
                ...
                <p><a href="http://t4t5.github.io/sweetalert/" target="_blank" class="btn btn-primary icon-btn"><i class="fa fa-file"></i>Docs</a></p>
              </div>
              <div class="card-body">
                <p>This plugin can be used as the replacement of native javascript alert, confirm and prompt functions.</p>
                <h4>Demo</h4><a id="demoSwal" href="#" class="btn btn-info">Sample Alert</a>
              </div>
            </div>
          </div>
        </div>
