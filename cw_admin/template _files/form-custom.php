        ...
        <div class="page-title">
          ...
          <div>
            <ul class="breadcrumb">
              ...
              <li>Forms</li>
              <li><a href="#">Custom Componants</a></li>
            </ul>
          </div>
        </div>
        <div class="row">
          <div class="col-md-6">
            <div class="card">
              <h3 class="card-title">Animated Checkbox and Radio Buttons</h3>
              <!--Radio Button Markup-->
          ...
          <div class="col-md-6">
            <div class="card">
              <h3 class="card-title">Animated Toggle Button</h3>
              ...
              <div class="toggle-flip">
                <label>
                  <input type="checkbox"><span data-toggle-on="ON" data-toggle-off="OFF" class="flip-indecator"></span>
                </label>
              </div>
              <h4>Disabled state</h4>
              <div class="toggle">
              ...
              <div class="toggle-flip">
                <label>
                  <input type="checkbox" disabled=""><span data-toggle-on="ON" data-toggle-off="OFF" class="flip-indecator"></span>
                </label>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-6">
            <div class="card">
              <div class="card-title-w-btn">
                ...
                <p><a href="https://select2.github.io/examples.php" target="_blank" class="btn btn-primary icon-btn"><i class="fa fa-file"></i>Docs</a></p>
              </div>
              <div class="card-body">
          ...
          <div class="col-md-6">
            <div class="card">
              <div class="card-title-w-btn">
                ...
                <p><a href="http://bootstrap-datepicker.readthedocs.org/en/stable/options.php" target="_blank" class="btn btn-primary icon-btn"><i class="fa fa-file"></i>Docs</a></p>
              </div>
              <div class="card-body">
                <p>This plugin can be used to let the user select the date in a convinient way.</p>
                <h4>Demo</h4>
                <input id="demoDate" type="text" placeholder="Select Date" class="form-control">
              </div>
            </div>
          </div>
          <div class="clearfix"></div>
          <div class="col-md-6">
            <div class="card">
              ...
              <div class="card-body">
                <button id="sl" type="button" class="btn btn-default">Loading State</button>
                <button id="el" type="button" class="btn btn-default">Loading Complete</button><br>
                <br><a id="tl" class="btn btn-primary">Submit</a>
                <button id="tb" class="btn btn-primary">Sign In</button>
              </div>
            </div>
          </div>
          <div class="col-md-6">
            <div class="card">
              <h3 class="card-title">Loading Buttons Docs</h3>
              <div class="card-body">
                <p>
                  Use <b>$('selector').loadingBtn()</b> method to enable loading button.<br><br>
                  
                  <b> Plugin Option 'text'. Data type is string. Default text is 'LOADING'</b><br><br>
                  
                  Use <b>$('selector').loadingBtnComplete()</b> method to disable loading button.<br><br>
                  
                  <b> Plugin Option 'html'. Data type is string. Default text is 'SUBMIT'</b>
