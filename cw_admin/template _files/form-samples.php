          ...
          <div class="col-md-6">
            <div class="card">
              ...
              <div class="card-body">
                <form>
                  ...
                  <div class="form-group">
                    ...
                    <textarea rows="4" placeholder="Enter your address" class="form-control"></textarea>
                  </div>
                  <div class="form-group">
              ...
              <div class="card-footer">
                <button type="button" class="btn btn-primary icon-btn"><i class="fa fa-fw fa-lg fa-check-circle"></i>Register</button>&nbsp;&nbsp;&nbsp;<a href="#" class="btn btn-default icon-btn"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancel</a>
              </div>
            </div>
          </div>
          <div class="col-md-6">
              ...
              <div class="card-body">
                <form class="form-horizontal">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      <input type="email" placeholder="Enter email address" class="form-control col-md-8">
                    </div>
                  </div>
                  <div class="form-group">
            ...
            <div class="card">
              ...
              <div class="card-body3">
                <form class="form-inline">
                  ...
                  <div class="form-group">
                    <button type="button" class="btn btn-primary icon-btn"><i class="fa fa-fw fa-lg fa-check-circle"></i>Subscribe</button>
                  </div>
                </form>
              </div>
            </div>
