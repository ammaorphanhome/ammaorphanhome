...
if(isset($_POST) && $_POST['submit']=='ADD') {
	 ...
	 if($description!='')
	{
		...
		$ans = str_replace('"',"~~", $an);
		 ...
		 $sth = $db->query("INSERT INTO `news`(`description`) VALUES ('$ans')");
	}
	if($sth == true)  { ?>
  ...
  if(isset($_POST) && $_POST['submit']=='EDIT')
  {
	...
	if($description!='')
	{
		$an = str_replace("'","^^", $description);
		$ans = str_replace('"',"~~", $an);
		//echo "UPDATE `news` SET `description`= '$ans' WHERE `guid`='$guid'";exit;
	$sth = $db->query("UPDATE `news` SET `description`= '$ans' WHERE `guid`='$qid'");
	}
  ...
  <body class="sidebar-mini fixed">
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            ...
            <ul class="breadcrumb">
              ...
              <li class="active"><a href="news.php">News and Events</a></li>
            </ul>
          </div>
		...
		<a href="<?php echo URL; ?>news.php" class="btn btn-info">Back</a>
        <div class="row">
	  ...
	  header('location:'.URL.'news.php'); 
          ...
          <div class="col-md-12">
		  <div><!--a href="news.php?action=add" class="btn btn-success"><i class="fa fa-lg fa-plus"></i>Add New</a> <!--<a href="news.php?action=edit" class="btn btn-info btn-flat"><i class="fa fa-lg fa-edit"></i></a--><!--a href="#" class="btn btn-warning btn-flat"><i class="fa fa-lg fa-trash"></i></a>--></div>
		  <?php
                ...
                <table id="sampleTable" class="table table-hover table-bordered">
                  <thead>
                    <tr>
                      ...
                      <th align="center">News and Events</th>
                      <!--th>Gender</th>
                      <th>Image</th-->
					  <th>Edit/Delete</th>
                    </tr>
				  ...
				  <?php 
                    ...
                    <tr>
                      ...
                      <td ><?php if(strlen($ans > 100)){ echo $ans;} else echo $ans;?></td>
					  
                     
					  <td class="center"><div class="btn btn-xs btn-group-xs"><a href="news.php?action=edit&guid=<?php echo $row[0]; ?>"  class="btn btn-inverse"><i class="fa fa-edit icon-only"></i></a> <a href="<?php echo URL; ?>news.php?action=deleteData&guid=<?php echo $row[0]; ?>" class="btn btn-danger" onClick="return delete1();"><i class="fa fa-trash icon-only"></i></a> </div></td>
                    </tr>
	  <?php $m++; } } ?>
                  </tbody>
                </table>
