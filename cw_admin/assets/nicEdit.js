...
var nicUploadButton = nicEditorAdvancedButton.extend({
	nicURI : 'http://mylattiz.bitboxsolutions.info/',
	addPane : function() {
		this.im = this.ne.selectedInstance.selElm().parentTag('IMG');
	...
	addForm : function() {
		...
		myDoc.write('<form method="post" action=nicUpload.php?id='+this.myID+'" enctype="multipart/form-data">');
	...
	startUpload : function() {
		...
		this.myStatus.setContent('<img src="images/ajax-loader.gif" style="float: right; margin-right: 40px;" /><strong>Uploading...</strong><br />Please wait');
		this.myForm.submit();
