        ...
        <div class="container">
          <div class="row">
            <div class="col-md-4 col-sm-6 col-xs-6 col-xxs-12 probootstrap-animate" data-animate-effect="fadeIn">
              <div class="probootstrap-image-text-block probootstrap-cause">
                ...
                <div class="probootstrap-cause-inner">
                  ...
                  <p>A food bank or foodbank is a non-profit, charitable organization that distributes food to those who have difficulty purchasing enough to avoid hunger.</p>
                  <p><a href="donate.php" class="btn btn-primary btn-black">Donate Now!</a></p>
                </div>
              </div>
            </div>
            <div class="col-md-4 col-sm-6 col-xs-6 col-xxs-12 probootstrap-animate" data-animate-effect="fadeIn">
              <div class="probootstrap-image-text-block  probootstrap-cause">
                <figure>
                  <img src="img/img_sm_2.jpg" class="img-responsive">
                </figure>
                <div class="probootstrap-cause-inner">
                  
                  <h2><a href="#">Help Children To Get Health</a></h2>
                  <p>Feed the Children exists to end childhood hunger. It's the cause upon which we were founded and the one we continue to fight each and every day.</p>
                  <p><a href="donate.php" class="btn btn-primary btn-black">Donate Now!</a></p>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-4 col-sm-6 col-xs-6 col-xxs-12 probootstrap-animate" data-animate-effect="fadeIn">
              <div class="probootstrap-image-text-block  probootstrap-cause">
                <figure>
                  <img src="img/img_sm_3.jpg" class="img-responsive">
                </figure>
                <div class="probootstrap-cause-inner">
                  <h2><a href="#">Help Children To Get Education</a></h2>
                  <p>We organize cloth distribution camps in slums, orphanages and old age houses. We as an organization strongly feel about destitute and for us.</p>
                  <p><a href="donate.php" class="btn btn-primary btn-black">Donate Now!</a></p>
                </div>
              </div>
            </div>
