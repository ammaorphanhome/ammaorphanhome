          ...
          <div class="row">
            <div class="col-md-12">
              <div class="probootstrap-slider-text probootstrap-animate" data-animate-effect="fadeIn" style="padding-top: 160px;">
                <h1 class="probootstrap-heading probootstrap-animate" style="font-size: 50px;">Causes</h1>
              </div>
            </div>
          </div>
        </div>
              ...
              <div class="row">
                  <div class="col-md-12">
                      <div class="probootstrap-slider-text probootstrap-animate" data-animate-effect="fadeIn">
                          <h1 class="probootstrap-heading probootstrap-animate">Causes <span>Together we can make a difference</span></h1>
                      </div>
                  </div>
              </div>
          </div>
              ...
              <div class="row">
                  <div class="col-md-4 col-sm-6 col-xs-6 col-xxs-12 probootstrap-animate" data-animate-effect="fadeIn">
                      <div class="probootstrap-image-text-block probootstrap-cause">
                          <figure>
                              <img src="img/food_help.jpg" alt="Free Bootstrap Template by uicookies.com" class="img-responsive">
                          </figure>
                          <div class="probootstrap-cause-inner">
                              <h2><a href="#">Help Children To Get Food</a></h2>

                              <p>Feed the children to end childhood hunger. It's the cause upon which we were founded and the one we continue to fight each and every day.</p>
                              <p><a href="donate.html" class="btn btn-primary btn-black">Donate Now!</a></p>
                          </div>
                      </div>
                  </div>
                  ...
                  <div class="col-md-4 col-sm-6 col-xs-6 col-xxs-12 probootstrap-animate" data-animate-effect="fadeIn">
                      <div class="probootstrap-image-text-block  probootstrap-cause">
                          <figure>
                              <img src="img/get_education.jpg" alt="Free Bootstrap Template by uicookies.com" class="img-responsive">
                          </figure>
                          <div class="probootstrap-cause-inner">
                  ...
                  <div class="col-md-4 col-sm-6 col-xs-6 col-xxs-12 probootstrap-animate" data-animate-effect="fadeIn">
                      <div class="probootstrap-image-text-block  probootstrap-cause">
                          <figure>
                              <img src="img/childern_health.jpg" alt="Free Bootstrap Template by uicookies.com" class="img-responsive">
                          </figure>
                          <div class="probootstrap-cause-inner">
                              <h2><a href="#">Help Children To Get Health</a></h2>

                              <p>Good heath is very imporant to groom the children physically and mentally  . We give high priority to the health and provide hygiene enviroment.</p>
                              <p><a href="#" class="btn btn-primary btn-black">Donate Now!</a></p>
                          </div>
                      </div>
                  </div>
                  ...
                  <div class="col-md-4 col-sm-6 col-xs-6 col-xxs-12 probootstrap-animate" data-animate-effect="fadeIn">
                      <div class="probootstrap-image-text-block  probootstrap-cause">
                          <figure>
                              <img src="img/save_girl.jpg" alt="Free Bootstrap Template by uicookies.com" class="img-responsive">
                          </figure>
                          <div class="probootstrap-cause-inner">
                              <h2><a href="#">Save Girl Child</a></h2>

                              <p>We do not differentiate between a girl and a boy child. Both of them are same for us. We educate and groom every child to all possible ways to build a better future.</p>
                              <p><a href="#" class="btn btn-primary btn-black">Donate Now!</a></p>
                          </div>
                      </div>
                  </div>
                  ...
                  <div class="col-md-4 col-sm-6 col-xs-6 col-xxs-12 probootstrap-animate" data-animate-effect="fadeIn">
                      <div class="probootstrap-image-text-block probootstrap-cause">
                          <figure>
                              <img src="img/cloth_distribution.jpg" alt="Free Bootstrap Template by uicookies.com" class="img-responsive">
                          </figure>
                          <div class="probootstrap-cause-inner">
                              <h2><a href="#">Help Children To Get Clothes</a></h2>

                              <p>We provide good clothing to our amma children, we strongly feel better clothing is so important to instill physical and mental confidences to our childern.</p>
                              <p><a href="donate.html" class="btn btn-primary btn-black">Donate Now!</a></p>
                          </div>
                      </div>
                  </div>
                  ...
                  <div class="col-md-4 col-sm-6 col-xs-6 col-xxs-12 probootstrap-animate" data-animate-effect="fadeIn">
                      <div class="probootstrap-image-text-block  probootstrap-cause">
                          <figure>
                              <img src="img/services_elders.jpg" alt="Free Bootstrap Template by uicookies.com" class="img-responsive">
                          </figure>
                          <div class="probootstrap-cause-inner">
                              <h2><a href="#">Services to Elders</a></h2>

                              <p>For serving elderly people who feels loneliness and uncared, or physically handicapped prefers to take care. We provides hygienic / nutritional food and minor medical care.</p>
                              <p><a href="#" class="btn btn-primary btn-black">Donate Now!</a></p>
                          </div>
                      </div>
                  </div>
